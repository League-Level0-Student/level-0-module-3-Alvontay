...
public class ShinyObjects {
	 ...
	 * *****************/
	final boolean canPlaySounds = false;	
	...
	void manyShinyObjects() {
		...
		String amountOfShiny = JOptionPane.showInputDialog("how many shiny objects do you want");
		int numOfShiny = Integer.parseInt(amountOfShiny);
		// 3. Play the sound that many times
		for (;numOfShiny > 0; numOfShiny--) {
			playMisterZee();
		}
